...
Будет сделана кластеризация, выделены дополнительные признаки, общий разведочный анализ данных, по категориям, выявлено влияние на целевой признак цена со следующими признаками: высота елки, рейтинг товара, кол-во покупок?.  
