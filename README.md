...
Реализована кластеризации значимых негабаритных числовых признаков Скидка, Цена, Цена со скидкой, Кол-во раз купили, feedbacks, rating. Его цель распределить «без учителя» товары на кластеры, рекомендованные к покупке (синий, желтый и зеленый цвета с оттенками) и не рекомендованные (фиолетовый)
<img src=img/DBSCAN.png width=60% height=60%>  
